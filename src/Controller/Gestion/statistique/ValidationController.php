...
class ValidationController extends BaseController
{
    ...
    #[Route('/gestion/statistique/valider/audience', name: 'app_gestion_statistique_valider_audience')]
    public function indexaudience(Request $request, DataTableFactory $dataTableFactory): Response
    {
        $permission = $this->menu->getPermissionIfDifferentNull($this->security->getUser()->getGroupe()->getId(), 'app_gestion_statistique_valider_avenir');
        ...
        return $this->render('gestion/statistique/valider/audience.html.twig', [
            'datatable' => $table,
    ...
    #[Route('/gestion/statistique/valider/demande', name: 'app_gestion_statistique_valider_demande')]
    public function indexdemande(Request $request, DataTableFactory $dataTableFactory): Response
    {

        $permission = $this->menu->getPermissionIfDifferentNull($this->security->getUser()->getGroupe()->getId(), 'app_gestion_statistique_valider_demande');
            ...
            ->createAdapter(ORMAdapter::class, [
                ...
                'query' => function (QueryBuilder $req) {
                    $req->select('p,co')
                        ...
                        ->setParameter('status', 'promesse_valider');
                }
            ])
        ...
        return $this->render('gestion/statistique/valider/demande.html.twig', [
            'datatable' => $table,
            'permition' => $permission
        ]);
    }

    #[Route('/gestion/statistique/valider/promesse', name: 'app_gestion_statistique_valider_promesse')]
    public function indexannne(Request $request, DataTableFactory $dataTableFactory): Response
    {
        $permission = $this->menu->getPermissionIfDifferentNull($this->security->getUser()->getGroupe()->getId(), 'app_gestion_statistique_valider_promesse');
        ...
        return $this->render('gestion/statistique/valider/promesse.html.twig', [
            'datatable' => $table,
            'permition' => $permission
        ]);
    }

    #[Route('/gestion/statistique/valider/rapport', name: 'app_gestion_statistique_valider_rapport')]
    public function indexrapportmission(Request $request, DataTableFactory $dataTableFactory): Response
    {
        $permission = $this->menu->getPermissionIfDifferentNull($this->security->getUser()->getGroupe()->getId(), 'app_gestion_statistique_valider_rapport');
            ...
            ->createAdapter(ORMAdapter::class, [
                ...
                'query' => function (QueryBuilder $req) {
                    $req->select('r,co')
                        ...
                        ->setParameter('status', 'missionrapport_valider');
                }
            ])
        ...
        return $this->render('gestion/statistique/valider/rapportmission.html.twig', [
            'datatable' => $table,
            'permition' => $permission
        ]);
    } 
