...
{
    const INDEX_ROOT_NAME = 'app_gestion_don_index';
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory,StatsService $statsService): Response
    {
        ...
        $table = $dataTableFactory->create()
            ...
            ->add('nom', TextColumn::class, ['label' => 'Récipiandaire'])
            ->add('numero', TextColumn::class, ['label' => 'Tel du récipiandaire'])
    ...
    {    
        return $this->render('gestion/don/show.html.twig', [
            'don' => $don,
            'espece' => $statsService->getfieldon($don, 'en_espece'),
            'nature' => $statsService->getfieldon($don, 'en_nature'),
        ]);
    }
